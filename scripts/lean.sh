...
mv ./feeds/luci/applications/luci-app-cpufreq/po/zh_Hans ./feeds/luci/applications/luci-app-cpufreq/po/zh_cn
ls -lah ./feeds/luci/applications/luci-app-cpufreq/po/zh_cn
